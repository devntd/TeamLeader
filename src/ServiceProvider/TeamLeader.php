...
namespace Devntd\TeamLeader\ServiceProvider;
...
class TeamLeader extends ServiceProvider
{
    ...
    public function register()
    {
        $this->app->singleton('teamleader', function ($app) {
            ...
            return new \Devntd\TeamLeader\TeamLeader($config['api_url'], $config['auth_url'], $config['client_id'], $config['client_secret'], $config['redirect_uri'], $config['client']);
        });
    }
